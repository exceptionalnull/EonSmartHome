...
{
    public class SmartHomeCypherTests
    {
        ...
        {
            var p = new EonData.SmartHome.TpLink.SmartHomeProtocol.SmartHomeCypher();
        ...
        public void CanEncryptDecrypt()
        {
            ...
            var p = new EonData.SmartHome.TpLink.SmartHomeProtocol("127.0.0.1");
